...
for repository in "${REPOSITORIES[@]}"; do
    ...
    BRANCH_PROTECTION_NAME="${BRANCH_PROTECTION_NAME//\"}"
    BRANCH_PROTECTION_ENFORCE_ADMINS="${BRANCH_PROTECTION_ENFORCE_ADMINS//\"}"
    BRANCH_PROTECTION_DISMISS="${BRANCH_PROTECTION_DISMISS//\"}"
    BRANCH_PROTECTION_CODE_OWNERS="${BRANCH_PROTECTION_CODE_OWNERS//\"}"
    BRANCH_PROTECTION_REQUIRED_REVIEWERS="${BRANCH_PROTECTION_REQUIRED_REVIEWERS//\"}"
